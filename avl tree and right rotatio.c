1.	Construct an AVL tree and excecute right  rotatio on it.
...
// Left rotation function (used in right rotation scenarios)
...
// Right rotation function (used when left child is too tall)
...
int main() {
    ...
    // Execute right rotation on the root (example)
